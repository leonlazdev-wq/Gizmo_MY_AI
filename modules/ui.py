...
theme = _safe_theme_set(
    ...
    background_fill_primary='#0f0f17',
    body_background_fill="#0f0f17",
    block_background_fill="#1c1c28",
    body_text_color="#e4e6eb",
    button_secondary_background_fill="transparent",
    button_secondary_border_color="#2a2a3d"
)
...
if not shared.args.old_colors:
    theme = _safe_theme_set(theme,
        ...
        body_text_color_subdued='#a0a4b0',
        background_fill_secondary='#16161f',
        background_fill_secondary_dark='var(--selected-item-color-dark, #262636)',
        background_fill_primary='#0f0f17',
        background_fill_primary_dark='var(--darker-gray, #1c1c28)',
        body_background_fill="#0f0f17",
        block_background_fill="#1c1c28",
        body_text_color='#e4e6eb',
        button_secondary_background_fill="transparent",
        ...
        # Dark Mode Colors
        input_background_fill_dark='var(--darker-gray, #1c1c28)',
        checkbox_background_color_dark='var(--darker-gray, #1c1c28)',
        block_background_fill_dark='transparent',
        block_border_color_dark='transparent',
        input_border_color_dark='var(--border-color-dark, #2a2a3d)',
        input_border_color_focus_dark='var(--border-color-dark, #6c63ff)',
        checkbox_border_color_dark='var(--border-color-dark, #2a2a3d)',
        border_color_primary_dark='var(--border-color-dark, #2a2a3d)',
        button_secondary_border_color_dark='var(--border-color-dark, #2a2a3d)',
        body_background_fill_dark='var(--dark-gray, #0f0f17)',
        button_primary_background_fill_dark='transparent',
        button_secondary_background_fill_dark='transparent',
        checkbox_label_background_fill_dark='transparent',
        button_cancel_background_fill_dark='transparent',
        button_secondary_background_fill_hover_dark='var(--selected-item-color-dark, #262636)',
        checkbox_label_background_fill_hover_dark='var(--selected-item-color-dark, #262636)',
        table_even_background_fill_dark='var(--darker-gray, #1c1c28)',
        table_odd_background_fill_dark='var(--selected-item-color-dark, #262636)',
        code_background_fill_dark='var(--darker-gray, #1c1c28)',
